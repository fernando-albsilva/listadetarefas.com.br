class ListaDeTarefaView {
    ...
    criaListaTemplate(listaDeTarefa) {
        let tabelaCabecalho = `   <h2 class="textoForm cabecalho">Lista de Tarefas</h2>     
    ...
    criaListaConcluidaTemplate(listaDeTarefa) {
        let tabelaCabecalho = `   <h2 class="textoForm cabecalho">Lista de Tarefas Concluidas</h2>     
                <table class="tabelaLista"  >
                    <thead>
                        <tr class="linhaTabela">
                            <td class="dataTabela">Nome da Tarefa</td>
