class InformacaoView {
    ...
    atualizaRelogioTemplateInformacao(tarefa) {
        console.log("entrou");
    ...
    tarefaPausadaTemplateInformacao(tarefa) {
        console.log("entrou");
    ...
    tarefaFinalizadaTemplateInformacao(tarefa) {
        console.log("entrou");
    ...
    tarefaExcluidaTemplateInformacao(tarefa) {
        console.log("entrou");
    ...
    tarefaEdicaoTemplateInformacao(tarefa, indice) {
        console.log("entrou");
        let template = `
    ...
    tarefaEdicaoTemplateInformacaoEfetuada(tarefa) {
        console.log("entrou");
